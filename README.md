...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/empty-test.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/bucket.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/serverless-regional.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/serverless-multiregion.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/endpoint.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/terraform.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/docker.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/kubernetes-quality.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/kubernetes-regional.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/kubernetes-multiregion.yml'
...
```yaml
include:
  - remote: 'https://raw.githubusercontent.com/gadiener/ci-templates/v1.0.2/kubernetes-task.yml'
